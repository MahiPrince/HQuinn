...
function renderAlternatives() {
  ...
  return packages || alternatives ? packages + alternatives : `<div class="empty-panel"><div class="empty-icon">↔</div><h3>Focused on the recommended route</h3><p>A second route will appear only when controlled evidence establishes a strong match with a meaningful customer trade-off.</p></div>`;
}
